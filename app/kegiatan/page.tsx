    ...
    <div>
      ...
      <div className="space-y-16">
        {kegiatanDivisi.map((divisi) => (
          ...
          >
            <h2 className="text-3xl font-bold text-[#1a4162] mb-8 border-b-4 border-[#1a4162] pb-2">
              Divisi {divisi.nama}
            </h2>
              ...
              {divisi.kegiatan.map((kegiatan, index) => (
                ...
                <div key={index} className="group perspective h-72">
                  ...
                  <div className="relative preserve-3d group-hover:rotate-y-180 w-full h-full duration-500 rounded-xl shadow-lg">
                    ...
                    {/* Sisi Belakang Kartu */}
                    <div className="absolute rotate-y-180 backface-hidden w-full h-full bg-[#1a4162] rounded-xl flex flex-col items-center justify-center text-center p-6">
                      <h3 className="text-2xl font-bold text-white mb-2">{kegiatan.judul}</h3>
                      <p className="text-[#e6d9c6]">Diselenggarakan oleh Divisi {divisi.nama}</p>
                    </div>
                  </div>
                </div>
              ))}
